...
then
  ...
  rdOld=$(wget -N https://github.com/rustdesk/rustdesk/releases/download/nightly/rustdesk-$version.x86_64.rpm | grep -c "Omitting Download") # Download Rustdesk nightly.
  if [[ $rOld -eq 0 ]]
  then
